    ...
    return (
        <div className='privacy-policy-container'>
            <header >
                ...
                <p><i>Last updated: March 6, 2024</i></p>
            ...
            <section>
                ...
                <article>
                    ...
                    <ul>
                        ...
                        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Transparent Property Management L.L.C., Office 1305, Bldg. 12, Tamouh Tower, Marina Square, Al Reem Island, Abu Dhabi.</li>
                        ...
                        <li><strong>Website</strong> refers to Transparent Property Management L.L.C., accessible from <a href='https://transparentpm.ae'>https://transparentpm.ae</a></li>
            ...
            <section>
                ...
                <article>
                    ...
                    <p><strong>Personal Data</strong> - While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. This may include, but is not limited to, Email address, First name and last name, Phone number.</p>
            ...
            <section>
                ...
                <article>
                    ...
                    <ul>
                        ...
                        <li><strong>Flash Cookies.</strong>Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read “Where can I change the settings for disabling, or deleting local shared objects?” available at <a href='https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_'>https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html</a></li>
                        <li><strong>Web Beacons.</strong>Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</li>
                        <li><strong>Google Analytics.</strong>Implemented to the entire website to track and gather insight in our customer / client behavior. It is also being used to track conversion, submissions, and bounce rates. The data will be solely used internally.</li>
                    </ul>
            ...
            <section>
                ...
                <ul>
                    <li>By email: <a href="mailto:joshua.jamelo@transparentpm.ae">joshua.jamelo@transparentpm.ae</a></li>
                    <li>By phone number: <a href="tel:+971564420883">+971 56 442 0883</a></li>
                </ul>
            </section>
        </div>
    )
